...
public:
	...
	bool nextChord(Tuning const& tuning,       NoteValue baseNote, music::Chord const& notes, unsigned bars = 16) noexcept;
	bool incrementString(Tuning const& tuning, NoteValue baseNote, music::Chord const& notes, int string, unsigned bars = 16) noexcept;

	bool containsAll(Tuning const& tuning, NoteValue baseNote, std::bitset<12> notes) noexcept;
